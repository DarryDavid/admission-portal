...
<div class="container-fluid  ">
	<div class="row">
		...
		<div class="col-md-4 border">
			...
			<h1 class="text-center text-warning ">SignUP Form</h1>


			<form method="post" action="job_signup_insert.php">
				...
				<div class="form-group input-group">
						...
						<label class="text-warning"><b>Confirm Password:</b></label>
						<i class="fa fa-lock" aria-hidden="true"></i>
						<input type="text" name="cnfpassword" class="form-control" style="border: 0;">		
				</div>
				...
				<div class="form-group">
				<label class="text-warning"><b>name:</b></label>
				<div class="input-group">
					<i class="fa fa-user icon"></i>
					<input type="text" name="name" class="form-control" style="border: 0;" >
				</div>
